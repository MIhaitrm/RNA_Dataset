...
# pt_files = glob.glob(os.path.join("pt_files", "*.pt"))

# for p in pt_files:
# 	load = torch.load(p, weights_only=False)
	# print(load['x'])
	# print(load.num_node_features)
	# print(load.num_classes)
# load = torch.load('1b7f.pt', weights_only=False)
# print(load['x'])
